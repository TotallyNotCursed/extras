...
public class ModBlocks {
  ...
  private static final DeferredRegister<Block> BLOCKS =
      DeferredRegister.create(TncExtras.MOD_ID, Registries.BLOCK);
  ...
  public static void register() {
    ...
    // ===============================
    COLDVEIN_ORE =
        BLOCKS.register("coldvein_ore", () -> new ColdveinOreBlock(BlockBehaviour.Properties.of()));
    DEEPSLATE_COLDVEIN_ORE =
        BLOCKS.register(
            "deepslate_coldvein_ore",
            () -> new DeepslateColdveinOreBlock(BlockBehaviour.Properties.of()));
