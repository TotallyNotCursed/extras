...
public class ModItems {
    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(TncExtras.MOD_ID, Registries.ITEM);
    ...
    public static void register() {
        ...
        // Armor
        // ===============================
        COLDVEIN_BOOTS = ITEMS.register(
                "coldvein_boots",
                () -> new ArmorItem(
                        ModArmorMaterials.COLDVEIN,
                        ArmorItem.Type.BOOTS,
                        new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        COLDVEIN_CHESTPLATE = ITEMS.register(
                "coldvein_chestplate",
                () -> new ArmorItem(
                        ModArmorMaterials.COLDVEIN,
                        ArmorItem.Type.CHESTPLATE,
                        new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        COLDVEIN_HELMET = ITEMS.register(
                "coldvein_helmet",
                () -> new ArmorItem(
                        ModArmorMaterials.COLDVEIN,
                        ArmorItem.Type.HELMET,
                        new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        COLDVEIN_LEGGINGS = ITEMS.register(
                "coldvein_leggings",
                () -> new ArmorItem(
                        ModArmorMaterials.COLDVEIN,
        ...
        // ===============================
        // Ores
        COLDVEIN_ORE = ITEMS.register(
                "coldvein_ore",
                () -> new BlockItem(
                        ModBlocks.COLDVEIN_ORE.get(), new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        DEEPSLATE_COLDVEIN_ORE = ITEMS.register(
        ...
        // ===============================
        COLDVEIN =
                ITEMS.register("coldvein", () -> new Item(new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        PULLSTONE_RING = ITEMS.register(
                "pullstone_ring",
                () -> new PullstoneRingItem(new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        SANCTIFIED_NOVA = ITEMS.register(
                "sanctified_nova",
        ...
        // Spawn eggs
        // ===============================
        GOREYE_SPAWN_EGG = ITEMS.register(
                "goreye_spawn_egg",
        ...
        COLDVEIN_HOE = ITEMS.register(
                ...
                () -> new HoeItem(
                        ...
                        -1.0f,
                        new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        COLDVEIN_PICKAXE = ITEMS.register(
                "coldvein_pickaxe",
                () -> new PickaxeItem(
                        ModToolMaterials.COLDVEIN,
                        1,
                        -2.8f,
                        new Item.Properties().arch$tab(ModCreativeTabs.TNC_EXTRAS)));
        COLDVEIN_SHOVEL = ITEMS.register(
                "coldvein_shovel",
                () -> new ShovelItem(
                        ModToolMaterials.COLDVEIN,
                        1.5f,
