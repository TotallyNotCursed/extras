...
public class ModSounds {
    ...
    public static void register() {
        ...
        // Items
        // ===============================
        PULLSTONE_RING_USE = SOUND_EVENTS.register(
                "item.pullstone_ring.use",
                () -> SoundEvent.createVariableRangeEvent(ModUtils.getResourceLocation("item.pullstone_ring.use")));
        SANCTIFIED_NOVA_USE = SOUND_EVENTS.register(
                "item.sanctified_nova.use",
                () -> SoundEvent.createVariableRangeEvent(ModUtils.getResourceLocation("item.sanctified_nova.use")));

        // ===============================
        // Armor
        // ===============================
        COLDVEIN_ARMOR_EQUIP = SOUND_EVENTS.register(
                "item.armor.equip_coldvein",
                () -> SoundEvent.createVariableRangeEvent(ModUtils.getResourceLocation("item.armor.equip_coldvein")));
