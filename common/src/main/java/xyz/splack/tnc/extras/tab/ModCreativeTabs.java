...
public class ModCreativeTabs {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("TNC Extras Creative Tab Registration");
    ...
    public static void register() {
        ...
        TNC_EXTRAS = CREATIVE_TABS.register("tnc_extras", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
                .title(Component.translatable("itemGroup.tnc_extras"))
                .icon(() -> ModItems.COLDVEIN.get().getDefaultInstance())
                .build());
        TNC_EXTRAS_WIP =
                CREATIVE_TABS.register("tnc_extras_wip", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1)
